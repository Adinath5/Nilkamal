...
public final class Constants {
    ...
    public static final String CHANNEL_NAME = "technopoints name";
    public static final String CHANNEL_DESC = "technopoints desc";
    ...
    public static final String FIREBASE_TOKEN="tokan";
    ...
    public static final String COMPANY_ADDRESS = "company_addres";
    public static final String COMPANY_CITY = "company_city";
    public static final String COMPANY_TALUKA = "company_tal";
    public static final String COMPANY_DISTRICT = "company_dist";
    ...
    public static final String COMPANY_GST = "company_gst";
    public static final String COMPANY_JURISDICTION = "company_jurisdiction";
    public static final String COMPANY_PROPRIETOR = "company_proprietor";
    public static final String COMPANY_FYSTARTDATE = "startdatefy";
    public static final String COMPANY_FYENDDATE = "enddatefy";
    public static final String COMPANY_PANNO = "panno";
    public static final String COMPANY_TANNO = "tanno";
    ...
    public static final String KEY_USERSPID = "spcode";
    ...
    public static String serverKey = "key=" + "AAAA4Ay465M:APA91bFCn9W0D68-GFu59gMs5dHYHg7bvL-oIIdB6nCUjZz6cCyc5mgynWdBIrqRUsYyQXAYUVJ9BZm2QrQZGXo--spVoTNllKQEj2NFYglbzjl82pe5NVabh-yvnwsyQ2nz-25XNp3L";
