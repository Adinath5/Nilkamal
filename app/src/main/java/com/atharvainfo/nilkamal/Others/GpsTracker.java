...
public class GpsTracker extends Service implements LocationListener {
    ...
    public void onCreate() {
        super.onCreate();
        application = (nilkamalpoultry) getApplication();
    ...
    public void onDestroy() {
        ...
        if (mGoogleApiClient != null) {
            LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient,
                    (com.google.android.gms.location.LocationListener) GpsTracker.this);
        }
    ...
    private void authenticate() {
        ...
        if (mAuth.getCurrentUser() != null) {
            ...
            Toast.makeText(GpsTracker.this, R.string.auth_failed,
    ...
    private GoogleApiClient.ConnectionCallbacks mLocationRequestCallback = new GoogleApiClient
        ...
        public void onConnected(Bundle bundle) {
            ...
            LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient,
                    request, (com.google.android.gms.location.LocationListener) GpsTracker.this);
    ...
    private void shutdownAndScheduleStartup(int when) {
        ...
        if (resultCode == ConnectionResult.SUCCESS) {
            ...
            Toast.makeText(GpsTracker.this, R.string.gplay_failed,
...
//                       Toast.makeText(getApplicationContext(), "Location updated from service!", Toast.LENGTH_SHORT).show();
    ...
    private void buildNotification() {
        ...
        PendingIntent resultPendingIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, SupervisorMain.class), PendingIntent.FLAG_UPDATE_CURRENT);
        mNotificationBuilder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.mipmap.ic_launcher)
                .setColor(ContextCompat.getColor(getApplicationContext(), R.color.global__primary))
