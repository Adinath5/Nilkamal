...
public class rpt_purchaseregister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rpt_purchaseregister);
        ...
        txtsdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(rpt_purchaseregister.this, date, mycal.get(Calendar.YEAR), mycal.get(Calendar.MONTH), mycal.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        ...
        txtedate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(rpt_purchaseregister.this, date1, mycal.get(Calendar.YEAR), mycal.get(Calendar.MONTH), mycal.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        getPurchaseRegister();
    ...
    private void initToolbar() {
        Objects.requireNonNull(getSupportActionBar()).setTitle("Purchase Register");
    ...
    private void getPurchaseRegister(){
        itemlist.clear();
        Tools.showSimpleProgressDialog(getApplicationContext(), "Getting Purchase Register...","Please Wait ...",false);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, myConfig.URl_GETPURCHASEREGISTERLIST,
                    ...
                    public void onResponse(String response) {
                        try
                        {
                            ...
                            if (jsonObject.optString("result").equals("success")) {
                                ...
                                adapter = new SimpleAdapter(rpt_purchaseregister.this, salesregisterlist, R.layout.saleregisteritemlist, new String[]{"A", "B", "C","D"}, new int[]{R.id.txtvochno, R.id.txtvdate, R.id.txtladgername, R.id.txtamount});
                            ...
                            e.printStackTrace();
                            Toast.makeText(rpt_purchaseregister.this,"No Data Found",Toast.LENGTH_LONG).show();
                        }
                    }
                },
        ...
        RequestQueue queue = Volley.newRequestQueue(rpt_purchaseregister.this);
