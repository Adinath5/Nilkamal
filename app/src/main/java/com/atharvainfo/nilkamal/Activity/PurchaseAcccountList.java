...
public class PurchaseAcccountList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_purchase_acccount_list);
        ...
        btnaddac.setOnClickListener(v -> {
            Intent partylist = new Intent(PurchaseAcccountList.this, NewPartyActivity.class);
    ...
    private void getAlllegerList(){
        ...
        RequestQueue queue = Volley.newRequestQueue(PurchaseAcccountList.this);
