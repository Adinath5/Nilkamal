    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtvdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(ActivityReceipt.this, date, mycal.get(Calendar.YEAR), mycal.get(Calendar.MONTH), mycal.get(Calendar.DAY_OF_MONTH)).show();
        ...
        btnselectac.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent partylist = new Intent(ActivityReceipt.this, AllAccountList.class);
            ...
            if( txtrecamount.getText().toString()!= null && !txtrecamount.getText().toString().isEmpty() && !txtrecamount.getText().toString().equals("0")){
                ...
                new AsyncTask<Void, Void, String>(){
                    protected String doInBackground(Void[] params) {
                        ...
                        try {
                            HttpRequest req = new HttpRequest(myConfig.URl_SAVECASHRECEIPTENTRY);
                ...
                try {
                    ...
                    if (jsonObject.optString("result").equals("success")) {
                        ...
                        for (int i = 0; i < json.length(); i++) {
                            ...
                            String PayVochno = obj.getString("recvochno");
                            txtreceiptno.setText(PayVochno);

                            btnsaverec.setEnabled(false);
                            Toast.makeText(ActivityReceipt.this, "Receipt Voucher Save Successfully...", Toast.LENGTH_SHORT).show();
                            sharedPreferences = getApplicationContext().getSharedPreferences("Mydata", MODE_PRIVATE);
                            editor = sharedPreferences.edit();
                            editor.putString("vochtype", "Receipt");
                            editor.putString("invoiceno", txtreceiptno.getText().toString());
                            editor.commit();
                            Intent pintent = new Intent(ActivityReceipt.this, Activity_webview.class);
        ...
        switch (serviceCode) {
            case jsoncode:
                ...
                try {
                    ...
                    ArrayAdapter arrayAdapter = new ArrayAdapter<String>(ActivityReceipt.this, android.R.layout.select_dialog_item, blist);
                    ...
                    sppaytype.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        ...
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Toast.makeText(ActivityReceipt.this, "value is "+ positonInt, Toast.LENGTH_SHORT).show();
                        }
