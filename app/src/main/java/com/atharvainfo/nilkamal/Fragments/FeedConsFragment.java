 ...
 */
public class FeedConsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_feed_cons, container, false);

        feedconslist = view.findViewById(R.id.feedconlist);
        ...
        getFeedConsumptionDetail();

        // Inflate the layout for this fragment
        return view;
    }

    public static FeedConsFragment newInstance(String text){
        FeedConsFragment f = new FeedConsFragment();
        Bundle b = new Bundle();
    ...
    private void getFeedConsumptionDetail(){

        showSimpleProgressDialog(getContext(), "Getting Feed Consumption Data...","Please Wait ...",false);
